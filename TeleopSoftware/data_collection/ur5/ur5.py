...
# pickblueblock task
# LIGHTNING_HOME = [-3.24221035, -3.08068964, -0.86233179, -1.72519601, -0.11948803,  0.85219808]

# putgreeninpot task (lid on)
# LIGHTNING_HOME = [-3.170846,-3.05749896,-0.91952047,-1.86823045,-0.05919768,1.02544238]
# observed_failures:
# LIGHTNING_HOME = [-3.16109118, -3.03974379, -0.92718548, -1.8808379,  -0.04617371,  1.03050771]
# certain_failures:
LIGHTNING_HOME = [-3.16103551, -3.04549535, -0.91890332, -1.87791775, -0.04801671,  1.0259583 ]
# influence_stochgreedy:
# LIGHTNING_HOME = [-3.16041471, -3.04276193, -0.92303037, -1.8817063,  -0.0460001,   1.03235285]

# uprightcup task
# LIGHTNING_HOME = [-3.15506537,-2.98186746,-1.04710938,-1.30881827,0.01525672,0.3855738]
# certain_failures:
# LIGHTNING_HOME = [-3.15334594, -2.98403372, -1.03329712, -1.337109, 0.01140336, 0.41176725]
# observed_failures:
# LIGHTNING_HOME = [-3.15249378, -2.98390221, -1.03496169, -1.32734226, 0.01071991, 0.40540905]
